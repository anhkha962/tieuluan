...
class Admin extends Controller{
    ...
    function XemThuonghieu()
        ...
        function SuaSanpham($id){
            ...
            $mota = $_POST["motasp"];
            $ha1 = $_FILES["hinhsp"]["name"]; 
            $up = $data->UpdateSanpham($tensp,$giasp,$tendm,$tenth,$tonkho,$noibat,$mota,$ha1, $id);
            ...
            // $sp = $data->InfSanpham($id);
            
            $this->view("Admin",[
                "Header"=>"header",
                "Menu"=>"menu",
                "Content"=>"SanPham/sua",
                "sp"=>$data->InfSanpham($_GET['id'])
                // "name"=>$a,
                // "thuonghieu" => $b,
                // "danhmuc" => $c,
                // "namedm"=>$d,
        ...
        function Giamgia(){
            ...
            $this->view("Admin",[
                ...
                "Menu"=>"menu",
                "Content"=>"giamgia",
                "giamgia" => $data->TaoGiamgia($tengg, $giatri,$id),
                "xemgiamgia" => $data->XemGiamgia()
            ]);
        }
