...
<div class="container mt-3">
        ...
        <h2 class="form-danhmuc">THÊM DANH MỤC</h2>
        <form class="form-content" method="POST">
            <div class="form-items">
                <label class="label">Tên danh mục</label><br>
                <input class="form-control" type="text" name="nhom_ten" placeholder="Nhập tên danh mục" required>
            </div>
            <div class="form-button" >
                
                <button id="submit" type="submit" class="btn btn-primary" name="themdm">Thêm danh mục</button>
