            ...
            <div class="col-9">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="list-order" role="tabpanel" aria-labelledby="list-profile-list">
                        <ul style="list-style: none; padding: 0">
                            <li style="margin: 5px 0; border-bottom: 1px solid rgba(0, 0, 0, 0.2); padding: 10px 10px">
                                <div class="row">
                                    <?php foreach($data["hd"] as $hd){ ?>
                                    <div class="col-5" style="border: 1px solid gray; margin: 1% 4%; border-radius: 10px; background-color: #FFFACD;box-shadow: 0 2px 4px 0 gray">
                                        <span>Mã hóa đơn:<?php echo $hd['hd_id']?></span>
                                        <br>
                                        <span>Ngày đặt: <?php echo $hd['ngaylap']?></span><br>
                                        Tổng thanh toán: <?php echo number_format($hd['tongtien'])?> VNĐ
                                        <br>
                                        <a style="color: orange; font-weight: 700" href="../Home/hoadon&hd_id=<?php echo $hd['hd_id']?>">Xem chi tiết</a>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="list-dmk" role="tabpanel" aria-labelledby="list-profile-list">
                        <div class="row">
                            <div class="col coldk">
                                <form action="/tieuluanmvc/home/profile" method="post">
                                    <div class="row">
                                        <div class="col-12 content">
                                            ...
                                            <div class="button-function">
                                                <button type="submit" name="doimk" class="btn btn-outline-dark btndangky">
                                                        XÁC NHẬN
                                                    </button>
