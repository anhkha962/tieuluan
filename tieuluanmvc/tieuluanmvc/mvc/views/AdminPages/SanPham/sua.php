            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-items">
                        ...
                        <input class="form-control" name="tensp" type="text" placeholder="Nhập tên sản phẩm" value="<?php foreach($data["name"] as $inf){ echo $inf["sp_ten"];} ?>">
                    </div>
                    <div class="form-items">
                        <label class="label">Giá</label><br>
                        <input class="form-control" name="giasp" type="text" placeholder="Nhập giá sản phẩm" value="<?php  foreach($data["name"] as $inf){echo $inf["sp_gia"];}?>">
                    </div>

                    <div class="form-items">
                        <label class="label">Thuộc danh mục</label><br>
                        <select name="tendm">
                    <option><?php foreach($data["namedm"] as $namedm){echo $namedm["nhom_ten"];}?></option>
                    ...
                    <div class="form-items">
                        ...
                        <select name="tenth">
                    <option><?php foreach($data["nameth"] as $nameth){echo $nameth["th_ten"];}?></option>
                ...
                <div class="col-6">
                    <div class="form-items">
                        ...
                        <textarea name="motasp" rows="7"><?php  foreach($data["name"] as $inf){echo $inf["sp_mota"];}?></textarea>
                    </div>
                    <div class="form-items">
