                        ...
                        <div class="header-align-right">
                            <div class="header-action-area">
                                ...
                                <div class="header-action-cart">
                                    <button class="btn-cart cart-icon" onclick="window.location.href='../home/giohang&tk=<?php echo $_SESSION['username']; ?>'">
                                            <span class="cart-count"><?php echo $data["chiso"]?></span>
                ...
                <div class="col-lg-12 sticky-md-none">
                    <div class="header-navigation-area">
                        <ul class="main-menu nav position-relative" id="menu-mobile">
                            <li><a href="../Main"><i class='bx bx-home'></i>Trang chủ</a></li>
