                    ...
                    <label>
                        ...
                        if ($secureHash != $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                $sql = "SELECT * FROM momo WHERE order_id = '$order_id'";
                                ...
                                if ($row > 0) {
                                    ...
                                    $sql = "UPDATE momo SET order_id = '$order_id', tongtien = '$money', note = '$note', vnp_response_code = '$vnp_response_code', code_vnpay = '$code_vnpay', code_bank = '$code_bank' WHERE order_id = '$order_id'";
                                    mysqli_query($conn, $sql);
                                } else {
                                    $sql = "INSERT INTO hoadon(order_id, tongtien, note, vnp_response_code, code_vnpay, code_bank, thoigian) VALUES ('$order_id', '$money', '$note', '$vnp_response_code', '$code_vnpay', '$code_bank','$date_time')";
                                    mysqli_query($conn, $sql);
                                }
