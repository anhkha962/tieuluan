...
<html lang="en">
    ...
    <body>
        ...
        .container .table-responsive .form-group{
            margin-top: 20px;
            margin-left: 10%;
        }
    </style>
                    ...
                    <label>
                        ...
                        if ($secureHash != $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                $conn = mysqli_connect('localhost', 'root', 'root', 'tieuluan');
                                ...
                                if ($row > 0) {
                                    ...
                                    $sql = "UPDATE hoadon SET order_id = '$order_id', money = '$money', note = '$note', vnp_response_code = '$vnp_response_code', code_vnpay = '$code_vnpay', code_bank = '$code_bank' WHERE order_id = '$order_id'";
                                    mysqli_query($conn, $sql);
                                } else {
                                    $sql = "INSERT INTO hoadon(order_id, thanh_vien, money, note, vnp_response_code, code_vnpay, code_bank, time) VALUES ('$order_id', '$taikhoan', '$money', '$note', '$vnp_response_code', '$code_vnpay', '$code_bank','$date_time')";
                                    mysqli_query($conn, $sql);
                                }
